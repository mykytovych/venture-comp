...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("
            INSERT INTO tours (title, class, country, city, available_seats, price, short_description, detailed_description, image)
            VALUES (:title, :class, :country, :city, :available_seats, :price, :short_description, :detailed_description, :image)
        ");
        $stmt->execute([
            ':title' => $title,
            ':class' => $class,
        ...
        // Додавання тегів до таблиці tour_tags
        ...
        $_SESSION['message'] = "Тур успішно додано!";
        header("Location: tours_admin.php");
        exit();
    } catch (PDOException $e) {
        $_SESSION['message'] = "Помилка під час додавання туру: " . $e->getMessage();
    }
}
        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Додавання нового туру</h3>
              ...
              <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div data-mdb-input-init class="form-outline">
                      <input type="number" id="available_seats" name="available_seats" class="form-control form-control-lg" required />
                ...
                <div class="mb-4">
                  <div data-mdb-input-init class="form-outline">
                    <textarea id="short_description" name="short_description" class="form-control form-control-lg" rows="3" required></textarea>
                    <label class="form-label" for="short_description">Короткий опис</label>
                  </div>
                </div>
                <div class="mb-4">
                  <div data-mdb-input-init class="form-outline">
                    <textarea id="detailed_description" name="detailed_description" class="form-control form-control-lg" rows="5"></textarea>
                ...
                <div class="mt-2 pt-2">
                  <button class="btn btn btn-block fa-lg gradient-custom-2 mb-3" style="background-color: #1f1e1e; color: #FFFEFA;" onclick="window.location.href='tours.php'">Скасувати</button>
