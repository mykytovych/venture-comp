...
<div class="col-md-6 offset-md-2" style="margin-top: 100px; margin-bottom: 20px;">
    <h1 style="font-size: 92px;"><b>Кошик</b></h1>
</div>
<div class="container">
    <?php if (empty($tours)) : ?>
    ...
    <?php else : ?>
                ...
                <div class="col-md-4">
                    <div class="card border border-secondary mb-3">
                        <div class="card-body">
                            ...
                            <a href="remove_from_cart.php?tour_id=<?= htmlspecialchars($tour['tour_id']) ?>" class="btn custom-button">Х</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="checkout.php" class="btn custom-button" style="background-color: #f55105; color: #FFFEFA; height: 70%;">Оформити замовлення</a>
            </div>
        </div>
    <?php endif; ?>
</div>
